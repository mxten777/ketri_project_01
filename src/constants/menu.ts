...
export const MENU_ITEMS: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "서비스 프로세스", path: "/industrial-health#service-process" },
    ],
  },
  {
    label: "먹는물 검사",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "측정 대상시설", path: "/indoor-air-quality#facilities" },
      { label: "측정 항목 및 기준", path: "/indoor-air-quality#standards" },
    ],
  },
  {
    label: "석면조사분석",
