          ...
          <div className="card p-8">
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="bg-primary-50 dark:bg-primary-900/20 rounded-xl p-6 mb-8">
                <h4 className="font-semibold mb-3">근골격계부담작업 11종</h4>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                <div className="border border-primary-200 dark:border-primary-800 rounded-xl p-6">
                  <h4 className="font-bold text-lg mb-3 text-primary-600 dark:text-primary-400">정기조사</h4>
                  <p className="text-neutral-600 dark:text-neutral-400">
                    근골격계부담작업이 있는 사업장은 <strong>3년마다 1회 이상</strong> 정기적으로 유해요인조사를 실시해야 합니다.
                  </p>
                </div>
                <div className="border border-orange-200 dark:border-orange-800 rounded-xl p-6">
                  <h4 className="font-bold text-lg mb-3 text-orange-600 dark:text-orange-400">수시조사</h4>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start space-x-4 bg-neutral-50 dark:bg-neutral-800 p-4 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold mb-2">설비·작업공정·작업량·작업속도 등 작업장 상황</h4>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">작업환경 전반에 대한 조사</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 bg-neutral-50 dark:bg-neutral-800 p-4 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold mb-2">작업시간·작업자세·작업방법 등 작업조건</h4>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">근로자의 실제 작업 방식 분석</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4 bg-neutral-50 dark:bg-neutral-800 p-4 rounded-xl">
                  ...
                  <div>
                    <h4 className="font-bold mb-2">작업과 관련된 근골격계질환 징후와 증상 유무</h4>
                    <p className="text-sm text-neutral-600 dark:text-neutral-400">근로자 건강 상태 파악</p>
                  </div>
                </div>
              </div>
