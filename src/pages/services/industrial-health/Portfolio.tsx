            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
                <div className="bg-primary-50 dark:bg-primary-900/20 p-6 rounded-xl text-center">
                  <div className="text-4xl font-bold text-primary-600 dark:text-primary-400 mb-2">1,200+</div>
                  <p className="text-neutral-600 dark:text-neutral-400">작업환경측정</p>
                </div>
                <div className="bg-secondary-50 dark:bg-secondary-900/20 p-6 rounded-xl text-center">
                  <div className="text-4xl font-bold text-secondary-600 dark:text-secondary-400 mb-2">450+</div>
                  <p className="text-neutral-600 dark:text-neutral-400">근골격계 유해요인조사</p>
                </div>
                <div className="bg-orange-50 dark:bg-orange-900/20 p-6 rounded-xl text-center">
                  <div className="text-4xl font-bold text-orange-600 dark:text-orange-400 mb-2">300+</div>
                  <p className="text-neutral-600 dark:text-neutral-400">화학물질관리</p>
                </div>
                <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-xl text-center">
                  ...
                  <p className="text-neutral-600 dark:text-neutral-400">중대재해 대응 컨설팅</p>
                </div>
              </div>
              ...
              <div className="space-y-6 mb-12">
                <div className="border border-neutral-200 dark:border-neutral-700 rounded-xl p-6">
                  <h4 className="font-bold text-lg mb-4 text-primary-600 dark:text-primary-400">제조업</h4>
                ...
                <div className="border border-neutral-200 dark:border-neutral-700 rounded-xl p-6">
                  <h4 className="font-bold text-lg mb-4 text-secondary-600 dark:text-secondary-400">건설업</h4>
                  <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
                ...
                <div className="border border-neutral-200 dark:border-neutral-700 rounded-xl p-6">
                  <h4 className="font-bold text-lg mb-4 text-orange-600 dark:text-orange-400">서비스업</h4>
                  <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
                ...
                <div className="border border-neutral-200 dark:border-neutral-700 rounded-xl p-6">
                  <h4 className="font-bold text-lg mb-4 text-green-600 dark:text-green-400">공공기관</h4>
                  <ul className="space-y-2 text-sm text-neutral-600 dark:text-neutral-400">
              ...
              <div className="space-y-6 mb-8">
                <div className="bg-neutral-50 dark:bg-neutral-800 p-6 rounded-xl">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2">자동차 부품 제조업체 - 근골격계질환 예방 프로그램</h4>
                ...
                <div className="bg-neutral-50 dark:bg-neutral-800 p-6 rounded-xl">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2">화학제품 제조업체 - 화학물질관리 시스템 구축</h4>
                      <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-3">
                ...
                <div className="bg-neutral-50 dark:bg-neutral-800 p-6 rounded-xl">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-bold text-lg mb-2">물류센터 - 작업환경 개선 프로젝트</h4>
                      <p className="text-neutral-600 dark:text-neutral-400 text-sm mb-3">
