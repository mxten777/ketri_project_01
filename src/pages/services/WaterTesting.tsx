    ...
    <div className="min-h-screen">
      <div className="bg-gradient-to-br from-cyan-600 to-blue-600 text-white py-16 lg:py-24">
        <div className="container-custom">
          <h1 className="text-4xl lg:text-5xl font-bold mb-4">먹는물 검사</h1>
          <p className="text-lg">수질검사 전문기관으로 안전한 먹는물을 책임집니다</p>
        </div>
      </div>
        ...
        <div className="card p-8">
          ...
          <div className="prose dark:prose-invert max-w-none">
            <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-6">
              먹는물관리법에 따른 수질검사를 수행하는 환경부 지정검사기관입니다.
              정확하고 신속한 분석으로 안전한 먹는물을 책임집니다.
            </p>
            ...
            <h3 className="text-2xl font-bold mt-8 mb-4">수질검사 항목</h3>
              ...
              <table className="w-full border-collapse">
                ...
                <tbody>
                  <tr className="bg-white dark:bg-neutral-800">
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 font-bold">일반세균</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 text-center">1개</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3">일반세균 (CFU/mL)</td>
                  </tr>
                  <tr className="bg-neutral-50 dark:bg-neutral-700">
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 font-bold">미생물</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 text-center">2개</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3">총대장균군, 분원성대장균군/대장균</td>
                  </tr>
                  <tr className="bg-white dark:bg-neutral-800">
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 font-bold">건강상 유해영향 무기물질</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 text-center">14개</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3">납, 불소, 비소, 세레늄, 수은, 시안, 크롬, 암모니아성질소, 질산성질소, 카드뮴, 붕소, 브롬산염, 스트론튬, 페놀</td>
                  </tr>
                  <tr className="bg-neutral-50 dark:bg-neutral-700">
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 font-bold">건강상 유해영향 유기물질</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 text-center">17개</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3">총트리할로메탄, 클로로포름, 브로모디클로로메탄, 디브로모클로로메탄, 페놀, 1,1,1-트리클로로에탄 외</td>
                  </tr>
                  <tr className="bg-white dark:bg-neutral-800">
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 font-bold">소독제 및 소독부산물</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 text-center">11개</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3">잔류염소, 총트리할로메탄, 클로로포름, 클로랄하이드레이트, 디클로로아세토니트릴, 포름알데히드 외</td>
                  </tr>
                  <tr className="bg-neutral-50 dark:bg-neutral-700">
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 font-bold">심미적 영향물질</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3 text-center">15개</td>
                    <td className="border border-neutral-300 dark:border-neutral-600 px-4 py-3">경도, 과망간산칼륨소비량, 냄새, 맛, 동, 색도, 세제, 수소이온농도, 아연, 염소이온, 증발잔류물, 철, 망간, 탁도, 황산이온, 알루미늄</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-6 mb-8">
              ...
              <p className="text-neutral-700 dark:text-neutral-300 mb-2">
                환경부로부터 먹는물 수질검사기관으로 지정받아 공신력 있는 검사 성적서를 발급합니다.
              </p>
