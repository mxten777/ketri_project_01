                  ...
                  <table className="w-full border-collapse text-sm">
                    <thead>
                      <tr className="bg-neutral-200 dark:bg-neutral-700">
                        ...
                        <th className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">수수료<br/>(부가세포함)</th>
                    ...
                    <tbody>
                      ...
                      <tr className="bg-white dark:bg-neutral-800">
                        <td rowSpan={2} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">수도법 제33조</td>
                        <td rowSpan={2} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">대형건축물 소유주 및 관리자</td>
                        ...
                        <td rowSpan={2} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">지역별 계수율 수수료 상이</td>
                      </tr>
                      <tr className="bg-white dark:bg-neutral-800">
                      ...
                      <tr className="bg-neutral-50 dark:bg-neutral-700">
                        <td rowSpan={3} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">지하수법 제20조</td>
                        <td rowSpan={3} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">지하수관정 소유주 및 이용자</td>
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">294,470</td>
                      ...
                      <tr className="bg-neutral-50 dark:bg-neutral-700">
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">151,580</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">1L</td>
                      </tr>
                      <tr className="bg-neutral-50 dark:bg-neutral-700">
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">120,340</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">1L</td>
                      </tr>

                      {/* 먹는물 관리법 */}
                      <tr className="bg-white dark:bg-neutral-800">
                        <td rowSpan={3} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">먹는물 관리법</td>
                        <td rowSpan={3} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">지자체 등</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">먹는샘물 (저품수)</td>
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">380,160</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">6L</td>
                        <td rowSpan={3} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2"></td>
                      </tr>
                      <tr className="bg-white dark:bg-neutral-800">
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">생물 (원수)</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">-</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">48</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">356,180</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">6L</td>
                      </tr>
                      <tr className="bg-white dark:bg-neutral-800">
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">336,710</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">4L</td>
                      </tr>

                      {/* 수도법 제29조 */}
                      <tr className="bg-neutral-50 dark:bg-neutral-700">
                        <td rowSpan={2} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">수도법 제29조</td>
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">359,040</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">4L</td>
                        <td rowSpan={2} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2"></td>
                      </tr>
                      <tr className="bg-neutral-50 dark:bg-neutral-700">
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">370,700</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">4L</td>
                      </tr>

                      {/* 식품위생법 */}
                      <tr className="bg-white dark:bg-neutral-800">
                        <td rowSpan={2} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">식품위생법</td>
                        <td rowSpan={2} className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">식품접객업소 및 식품제조업소</td>
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">58,080</td>
                      ...
                      {/* 식품 및 건강기능식품제조업 */}
                      <tr className="bg-neutral-50 dark:bg-neutral-700">
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">식품 및 건강기능식품제조업</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">식품 제조업자</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">음용수 46항목</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">년 1회<br/>출고 분기 1회</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">46</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-right">294,470</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">4L</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2"></td>
                      ...
                      {/* 재활/복지 */}
                      <tr className="bg-white dark:bg-neutral-800">
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">재활/복지</td>
                      ...
                      {/* 클럽강조전달 */}
                      <tr className="bg-neutral-50 dark:bg-neutral-700">
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">클럽강조전달</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">시설 관리자 등</td>
                        ...
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 text-center">1L</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">클럽강 물은 지역별 가수율 상이</td>
                      </tr>

                      {/* 정수기 */}
                      <tr className="bg-white dark:bg-neutral-800">
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2 font-bold">-</td>
                        <td className="border border-neutral-300 dark:border-neutral-600 px-3 py-2">-</td>
