...
const Equipment = () => {
  ...
  const equipment = [
    {
      category: "먹는물",
      name: "가스크로마토그래피-질량분석기(GC-MSD)/퍼지앤트랩(Purge&Trap)",
      model: "7890B-5977A/Stratum",
    ...
    },
    {
      category: "먹는물",
      name: "가스크로마토그래피-질량분석기(GC-MSD)/퍼지앤트랩(Purge&Trap)",
      model: "2010PLUS-QP2010/PT7000",
      manufacturer: "SHIMADZU",
      testItems: "휘발성유기화합물 등",
    ...
    },
    {
      ...
      model: "7890A-NPD",
      manufacturer: "Agilent",
      testItems: "유기인계농약, 카바릴 등",
      image: "/images/equipment/images_01/equip_009.jpeg",
    },
    {
      category: "먹는물",
      name: "고성능액체크로마토그래피-형광검출기(HPLC-FLD)",
      model: "e2695-2475",
      manufacturer: "WATERS",
      testItems: "카바릴",
