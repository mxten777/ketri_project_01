        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="w-64 h-64 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-primary-100 to-secondary-100 dark:from-primary-900 dark:to-secondary-900 flex items-center justify-center">
              <User size={80} className="text-primary-600 dark:text-primary-400" />
            </div>
          ...
          >
            <div className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <p>
                저희 한국환경안전연구소는 <strong>환경보호</strong>와 <strong>안전관리</strong>를 통해 
                국민의 건강하고 안전한 삶을 지원하는 전문 연구기관입니다.
              </p>
              
              <p>
                산업보건, 먹는물 검사, 실내공기질 측정, 석면 조사·분석 등 다양한 분야에서 
                축적된 <strong>전문성</strong>과 <strong>신뢰성</strong>을 바탕으로 
                고객 여러분께 최고 품질의 서비스를 제공하고 있습니다.
              </p>
              
              <p>
                특히 급변하는 환경 규제와 안전 기준에 발맞춰 지속적인 연구개발과 
                첨단 장비 도입을 통해 정확하고 신속한 분석 서비스를 제공하겠습니다.
              </p>
