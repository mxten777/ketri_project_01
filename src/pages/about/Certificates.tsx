...
import { Award, CheckCircle, Calendar, FileText, Download, ExternalLink } from 'lucide-react';
...
const Certificates = () => {
  ...
  const categories = [
    ...
    { name: 'KOLAS 인정', count: certificates.filter(c => c.category === 'KOLAS 인정').length },
    { name: 'ISO 인증', count: certificates.filter(c => c.category === 'ISO 인증').length },
    { name: '환경부 등록', count: certificates.filter(c => c.category === '환경부 등록').length },
    { name: '기타', count: certificates.filter(c => !['KOLAS 인정', 'ISO 인증', '환경부 등록'].includes(c.category)).length }
  ];
      ...
      <section className="section container-custom">
        ...
        >
          {categories.map((category) => (
            <div key={category.name} className="text-center p-6 bg-white dark:bg-neutral-800 rounded-2xl shadow-soft">
              ...
              <div className="p-6">
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="text-sm text-neutral-500 dark:text-neutral-400">발급기관</div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="grid grid-cols-2 gap-4 flex-1">
                      <div>
                        <div className="text-sm text-neutral-500 dark:text-neutral-400">발급일</div>
                        <div className="font-medium">{cert.date}</div>
                      </div>
                      <div>
                        <div className="text-sm text-neutral-500 dark:text-neutral-400">유효기간</div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-sm text-neutral-500 dark:text-neutral-400">인정범위</div>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div className="bg-white dark:bg-neutral-800 px-6 py-3 rounded-xl">
              <span className="text-sm text-neutral-500 dark:text-neutral-400">전화</span>
              <div className="font-bold">043.237.7624~5</div>
            </div>
            <div className="bg-white dark:bg-neutral-800 px-6 py-3 rounded-xl">
              <span className="text-sm text-neutral-500 dark:text-neutral-400">팩스</span>
