      ...
      <section className="relative bg-gradient-to-br from-primary-600 via-primary-700 to-blue-800 dark:from-primary-700 dark:via-primary-800 dark:to-blue-900 text-white py-20 overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-4">오시는 길</h1>
          ...
          >
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-neutral-200 dark:border-neutral-700 group">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-lg mb-2 text-neutral-900 dark:text-white">주소</h3>
                  <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                    충북 청주시 서원구<br />남이면 양동3길 7-30
                  </p>
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-neutral-200 dark:border-neutral-700 group">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-lg mb-2 text-neutral-900 dark:text-white">전화번호</h3>
                  <a href="tel:043-237-7624" className="text-neutral-700 dark:text-neutral-300 hover:text-primary-600 transition-colors block">
                    대표: 043-237-7624~5
                  </a>
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-300 border border-neutral-200 dark:border-neutral-700 group">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-lg mb-2 text-neutral-900 dark:text-white">이메일</h3>
                  <a href="mailto:kesri0728@naver.com" className="text-neutral-700 dark:text-neutral-300 hover:text-primary-600 transition-colors break-all">
                    kesri0728@naver.com
                  </a>
                  <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-2">
                    업무 문의 및 견적 요청
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div className="text-center group">
              ...
              <p className="text-neutral-600 dark:text-neutral-400 leading-relaxed">
                043-237-7624~5<br />평일 08:00-18:00
              </p>
            </div>
          </div>
          ...
          <div className="p-6 bg-white dark:bg-neutral-800 rounded-2xl text-center border border-neutral-200 dark:border-neutral-700">
            <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
              <strong className="text-primary-600 dark:text-primary-400">방문 시 참고사항:</strong>{" "}
              시료 접수나 상담을 위한 방문 시에는 사전에 전화로 연락해 주시면 더욱 신속한 서비스를 받으실 수 있습니다.
            </p>
          </div>
        </motion.div>
        </div>
