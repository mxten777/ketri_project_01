    ...
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-900">
      ...
      <section className="section container-custom">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-12">
            <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-soft">
              ...
              <div className="text-3xl font-bold text-primary-600 dark:text-primary-400 mb-2">28</div>
              <div className="text-sm text-neutral-600 dark:text-neutral-400">총 직원 수</div>
            </div>

            <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-soft">
              <Building className="w-12 h-12 text-blue-500 mx-auto mb-4" />
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">5</div>
              <div className="text-sm text-neutral-600 dark:text-neutral-400">부서</div>
            </div>
            ...
            <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-soft">
              ...
              <div className="text-sm text-neutral-600 dark:text-neutral-400">전문인력 비율</div>
            </div>

            <div className="bg-white dark:bg-neutral-800 rounded-2xl p-6 shadow-soft">
              <Award className="w-12 h-12 text-orange-500 mx-auto mb-4" />
              <div className="text-3xl font-bold text-orange-600 dark:text-orange-400 mb-2">15+</div>
              <div className="text-sm text-neutral-600 dark:text-neutral-400">보유 자격증</div>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {departments.slice(1).map((dept, index) => (
              ...
              >
                <div className={`w-4 h-4 ${dept.color} rounded-full mx-auto mb-4`}></div>
        ...
        <motion.div
          ...
          className="mb-16"
        >
          <h3 className="text-2xl font-bold text-center mb-8">보유 인증 및 지정</h3>
